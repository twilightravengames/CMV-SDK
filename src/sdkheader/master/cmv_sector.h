//The data structure representing the 3-D space version
//of the StruMML/RDS document system in it's definition and 
//current state.
/*************************************************
...
public:
	...
	//
	void struMMLToSector();
	void getHyperLinks();
	//TODO: Add getters and setters to get dsata files related to tags in StruMML doc 
