...
//////////////////////////////
// cmvRDSServerMgr
// Purpose: Manages the RDS session server side only 
//			Responsible for taking incoming RDS documents from clients, negotiating their 
//			session and then submission of updated RDS documents to clients (synchronization)

class cmvRDSServerMgr
{
public:
	//Default constructor
	cmvRDSServerMgr();
