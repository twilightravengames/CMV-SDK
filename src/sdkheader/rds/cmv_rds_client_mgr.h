...
//////////////////////////////
// cmvRDSClientMgr
// Purpose: Manages the RDS session client side only
//			Receives RDS documents from server, manages updates to the scene graph according to incoming RDS docs
//			apply state changes to scene graph, and submit new RDS state document to server

class cmvRDSClientMgr
{
public:
	//Default constructor
	cmvRDSClientMgr();
